...
This addon supports configuration through Storybook parameters. You can configure the addon at different levels:
...
- `enabled` (boolean): Enable or disable the addon for this story
- `message` (string): Custom message to display in the addon panel
- `iterations` (number): Number of stress test iterations
- `delay` (number): Delay between iterations in milliseconds
